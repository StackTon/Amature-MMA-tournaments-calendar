...
export default class Header extends Component {
    render() {
        const { loggedIn, onLogout, isAdmin = false } = this.props;
        ...
        return (
            <header>
                ...
                {isAdmin && <NavLink to="/approvel/tournamens" activeClassName="active">Approvel Tounamets</NavLink>}
                {isAdmin && <NavLink to="/admin/panel" activeClassName="active">Admin Panel</NavLink>}
